...
public class PullToRefreshListView extends ListView{
    ...
    private void init(){
        ...
        pullToRefreshText ="下拉刷新"; //getContext().getString(R.string.ptr_pull_to_refresh);
        releaseToRefreshText = "释放立即刷新";//getContext().getString(R.string.ptr_release_to_refresh);
        refreshingText ="正在刷新...";// getContext().getString(R.string.ptr_refreshing);
        lastUpdatedText ="刷新成功"; //getContext().getString(R.string.ptr_last_updated);
